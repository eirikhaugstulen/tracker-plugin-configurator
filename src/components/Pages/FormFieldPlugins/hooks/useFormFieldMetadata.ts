...
const ProgramMetadataSchema = z.object({
    id: z.string({ error: 'Program id is missing in the API Payload. Please report the issue to the app maintainer.' }),
    displayName: z.string({ error: 'Program display name is missing in the API Payload. Please report the issue to the app maintainer.' }),
    access: z.object({
    ...
    programType: z.string({ error: 'Program type is missing in the API Payload. Please report the issue to the app maintainer.' }),
...
const TrackedEntityTypeMetadataSchema = z.object({
    id: z.string({ error: 'Tracked entity type id is missing in the API Payload.' }),
    displayName: z.string({ error: 'Tracked entity type display name is missing in the API Payload.' }),
});
