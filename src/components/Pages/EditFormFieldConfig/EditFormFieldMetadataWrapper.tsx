...
export const EditFormFieldMetadataWrapper = () => {
    ...
    // Map the new metadata types to the expected props format for EditFormFieldConfig
    const mappedMetadataType =
        metadataType === 'trackerProgram' || metadataType === 'eventProgram' || metadataType === 'programStage'
            ? 'program'
            : metadataType;
